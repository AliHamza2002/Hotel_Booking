    ...
    return (
        <div className='max-w-4xl  pb-20'>
            <div className='space-y-8'>
                <Title align='left' font='outfit' tittle='Add Room' subTittle='Fill in the details carefully and accurate room details, pricing and amenities to enhance the user booking experience.' />
                        ...
                        {Object.keys(images).map((key) => (
                            <div key={key} className='relative group'>
                                <label htmlFor={`roomImage${key}`} className='block'>
                                    <div className={`aspect-square rounded-xl border-2 border-dashed ${images[key] ? 'border-gray-300' : 'border-gray-300 hover:border-blue-500'} cursor-pointer overflow-hidden bg-gray-50 hover:bg-gray-100 transition-all relative`}>
                                        {images[key] ? (
                                            <>
                                                <img className='w-full h-full object-cover' src={URL.createObjectURL(images[key])} alt={`Room ${key}`} />
                                                {uploading[key] && (
